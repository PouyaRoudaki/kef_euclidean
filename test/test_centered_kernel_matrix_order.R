# Example: 5 items, 3 permutations in each matrix
...
eval_points_1  <- rbind(p1, p2, p3)      # 2 x 5
eval_points_2  <- rbind(p1, p2, p3)      # 2 x 5
centering_grid <- rbind(p1, p2, p3, p4)  # 3 x 5

K <- centered_kernel_matrix(eval_points_1,
                                 eval_points_2,
                                 centering_grid,
                                 hurst_coef = 0.5,data_type = "order")
K
...
centered_kernel_mat_at_sampled <- centered_kernel_matrix(samples,
                                                               samples,
                                                               centering_grid,
                                                               hurst_coef = 0.5,
                                                               data_type = "order")

head(centered_kernel_mat_at_sampled[, 1:7],7)
