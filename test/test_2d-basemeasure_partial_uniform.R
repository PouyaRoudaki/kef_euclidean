...
samples1 <- cbind(runif(n1, min = 0,max = 0.5),
                  runif(n1, min = 0,max = 0.5))

n2 <- 10

samples2 <- cbind(runif(n2, min = 0,max = 0.5),
                  runif(n2, min = 0.5,max = 1))

n3 <- 10

samples3 <- cbind(runif(n3, min = 0.5,max = 1),
                  runif(n3, min = 0,max = 0.5))

n4 <- 70

samples4 <- cbind(runif(n4, min = 0.5,max = 1),
                  runif(n4, min = 0.5,max = 1))

samples <- rbind(samples1, rbind(samples2, rbind(samples3, samples4)))
